<?php
if (!function_exists('__b33a51b111683b7dc1ef49041de5fdec')):
function __b33a51b111683b7dc1ef49041de5fdec($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
                ...
                <div <?php echo e($contentAttributes->class($contentClasses)); ?> data-flux-modal-content>
                    ...
                    <?php if ($closable): ?>
                        <div class="absolute top-0 end-0 mt-4 me-4">
                            <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/modal/close.blade.php', $__blaze->compiledPath.'/af7dd412fb00020e647006a5fccc1d8c.php'); ?>
<?php if (isset($__slotsaf7dd412fb00020e647006a5fccc1d8c)) { $__slotsStackaf7dd412fb00020e647006a5fccc1d8c[] = $__slotsaf7dd412fb00020e647006a5fccc1d8c; } ?>
<?php if (isset($__attrsaf7dd412fb00020e647006a5fccc1d8c)) { $__attrsStackaf7dd412fb00020e647006a5fccc1d8c[] = $__attrsaf7dd412fb00020e647006a5fccc1d8c; } ?>
<?php $__attrsaf7dd412fb00020e647006a5fccc1d8c = []; ?>
<?php $__slotsaf7dd412fb00020e647006a5fccc1d8c = []; ?>
<?php $__blaze->pushData($__attrsaf7dd412fb00020e647006a5fccc1d8c); ?>
<?php ob_start(); ?>
...
<?php $__attrs8ec60061103802631d4e7d10363270b6 = ['variant' => 'ghost','icon' => 'x-mark','size' => 'sm','ariaLabel' => e(__('Close modal')),'class' => 'text-zinc-400! hover:text-zinc-800! dark:text-zinc-500! dark:hover:text-white!']; ?>
<?php $__slots8ec60061103802631d4e7d10363270b6 = []; ?>
<?php $__blaze->pushData($__attrs8ec60061103802631d4e7d10363270b6); ?>
<?php ob_start(); ?><?php $__slots8ec60061103802631d4e7d10363270b6['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots8ec60061103802631d4e7d10363270b6); ?>
<?php __8ec60061103802631d4e7d10363270b6($__blaze, $__attrs8ec60061103802631d4e7d10363270b6, $__slots8ec60061103802631d4e7d10363270b6, [], ['ariaLabel' => 'aria-label'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
                            <?php $__slotsaf7dd412fb00020e647006a5fccc1d8c['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsaf7dd412fb00020e647006a5fccc1d8c); ?>
<?php __af7dd412fb00020e647006a5fccc1d8c($__blaze, $__attrsaf7dd412fb00020e647006a5fccc1d8c, $__slotsaf7dd412fb00020e647006a5fccc1d8c, [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackaf7dd412fb00020e647006a5fccc1d8c)) { $__slotsaf7dd412fb00020e647006a5fccc1d8c = array_pop($__slotsStackaf7dd412fb00020e647006a5fccc1d8c); } ?>
<?php if (! empty($__attrsStackaf7dd412fb00020e647006a5fccc1d8c)) { $__attrsaf7dd412fb00020e647006a5fccc1d8c = array_pop($__attrsStackaf7dd412fb00020e647006a5fccc1d8c); } ?>
<?php $__blaze->popData(); ?>
                        </div>
                    <?php endif; ?>
                </div>
...
} endif; ?><?php /**PATH /home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/modal/index.blade.php ENDPATH**/ ?>
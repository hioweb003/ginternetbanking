<?php
if (!function_exists('__29547ba049cb40f9df3a3b626f350b68')):
function __29547ba049cb40f9df3a3b626f350b68($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if ($type === 'file'): ?>
    <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/with-field.blade.php', $__blaze->compiledPath.'/584419564efcb469bd59843bbbc26a1d.php'); ?>
<?php if (isset($__slots584419564efcb469bd59843bbbc26a1d)) { $__slotsStack584419564efcb469bd59843bbbc26a1d[] = $__slots584419564efcb469bd59843bbbc26a1d; } ?>
<?php if (isset($__attrs584419564efcb469bd59843bbbc26a1d)) { $__attrsStack584419564efcb469bd59843bbbc26a1d[] = $__attrs584419564efcb469bd59843bbbc26a1d; } ?>
<?php $__attrs584419564efcb469bd59843bbbc26a1d = ['attributes' => $attributes,'name' => $name]; ?>
<?php $__slots584419564efcb469bd59843bbbc26a1d = []; ?>
<?php $__blaze->pushData($__attrs584419564efcb469bd59843bbbc26a1d); ?>
<?php ob_start(); ?>
        <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/file.blade.php', $__blaze->compiledPath.'/4a3d04ec7140115a25f3b80c28dd66ac.php'); ?>
<?php $__blaze->pushData(['attributes' => $attributes,'name' => $name,'size' => $size]); ?>
<?php __4a3d04ec7140115a25f3b80c28dd66ac($__blaze, ['attributes' => $attributes,'name' => $name,'size' => $size], [], ['attributes', 'name', 'size'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php $__slots584419564efcb469bd59843bbbc26a1d['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots584419564efcb469bd59843bbbc26a1d); ?>
<?php __584419564efcb469bd59843bbbc26a1d($__blaze, $__attrs584419564efcb469bd59843bbbc26a1d, $__slots584419564efcb469bd59843bbbc26a1d, ['attributes', 'name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack584419564efcb469bd59843bbbc26a1d)) { $__slots584419564efcb469bd59843bbbc26a1d = array_pop($__slotsStack584419564efcb469bd59843bbbc26a1d); } ?>
<?php if (! empty($__attrsStack584419564efcb469bd59843bbbc26a1d)) { $__attrs584419564efcb469bd59843bbbc26a1d = array_pop($__attrsStack584419564efcb469bd59843bbbc26a1d); } ?>
<?php $__blaze->popData(); ?>
...
<?php __1076136291a468841f5527c710e431e9($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                </div>
            ...
            <input
                ...
                [STARTCOMPILEDUNBLAZE:9PfHEpalj9]<?php \Livewire\Blaze\Unblaze::storeScope("9PfHEpalj9", scope: ['name' => $name ?? null, 'invalid' => $invalid ?? false]) ?>[ENDCOMPILEDUNBLAZE:9PfHEpalj9]
                data-flux-control
...
<?php __1076136291a468841f5527c710e431e9($__blaze, ['name' => 'loading','variant' => $iconVariant,'class' => $iconClasses,'wire:loading' => true,'wire:target' => $wireTarget], [], ['variant', 'class', 'wire:loading', 'wire:target'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($clearable): ?>
                        <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/clearable.blade.php', $__blaze->compiledPath.'/cb39e348a74c9c0dd6b56a03c406bdb2.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __cb39e348a74c9c0dd6b56a03c406bdb2($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>
                    ...
                    <?php if ($expandable): ?>
                        <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/expandable.blade.php', $__blaze->compiledPath.'/c128cd6ea4c55f493046c18533e06a2e.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __c128cd6ea4c55f493046c18533e06a2e($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($copyable): ?>
                        <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/copyable.blade.php', $__blaze->compiledPath.'/e97f85de441d1cfa26ddbf55bccc2243.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __e97f85de441d1cfa26ddbf55bccc2243($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>

                    <?php if ($viewable): ?>
                        <?php $__blaze->ensureRequired('/home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/viewable.blade.php', $__blaze->compiledPath.'/054307ca4f67b5ab7f1c6a12832228df.php'); ?>
<?php $__blaze->pushData(['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant]); ?>
<?php __054307ca4f67b5ab7f1c6a12832228df($__blaze, ['inset' => 'left right','size' => $size,'iconVariant' => $iconVariant], [], ['size', 'iconVariant'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
                    <?php endif; ?>
...
<?php __1076136291a468841f5527c710e431e9($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $trailingIconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __1076136291a468841f5527c710e431e9($__blaze, ['icon' => $iconTrailing,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php elseif  ($iconTrailing): ?>
...
} endif; ?><?php /**PATH /home/henry/Desktop/htdocs/grubinternetbanking/vendor/livewire/flux/src/../stubs/resources/views/flux/input/index.blade.php ENDPATH**/ ?>
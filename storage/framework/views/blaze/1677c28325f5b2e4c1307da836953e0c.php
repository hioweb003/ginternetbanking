<?php
if (!function_exists('__1677c28325f5b2e4c1307da836953e0c')):
function __1677c28325f5b2e4c1307da836953e0c($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php ob_start(); ?><?php echo e($content); ?><?php $__slotsa3135de46300f669a9a8e42bedbaf8ae['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsa3135de46300f669a9a8e42bedbaf8ae); ?>
<?php __a3135de46300f669a9a8e42bedbaf8ae($__blaze, $__attrsa3135de46300f669a9a8e42bedbaf8ae, $__slotsa3135de46300f669a9a8e42bedbaf8ae, ['kbd'], [], $__this ?? (isset($this) ? $this : null)); ?>
